...
def enroll_dialog():
    ...
    join_code = st.text_input('Subject Code', placeholder='Eg. CS101', key='enroll_code_input')

    if st.button('Enroll now', type='primary', width='stretch', key='enroll_submit_btn'):
        if join_code:
            try:
